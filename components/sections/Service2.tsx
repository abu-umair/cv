									...
									<div className="row g-4">
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular">Crafting visually appealing and user-friendly interfaces using <span className="text-secondary-2">HTML</span>, <span className="text-secondary-2">CSS</span>, <span className="text-secondary-2">JavaScript</span>, and modern frameworks like <span className="text-secondary-2">Tailwind CSS</span> or <span className="text-secondary-2">Bootstrap</span>, <span className="text-secondary-2">React</span> or <span className="text-secondary-2">Next.js</span>, and <span className="text-secondary-2">TypeScript</span>.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular">Designing and managing databases with SQL technologies such as <span className="text-secondary-2">MySQL</span>, and <span className="text-secondary-2">PostgreSQL</span>.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular">Building scalable backend architectures using <span className="text-secondary-2">RESTful APIs</span>, <span className="text-secondary-2">WebSockets</span>, and <span className="text-secondary-2">gRPC</span> to ensure lightning-fast data exchange and seamless real-time synchronization between systems.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Scalable System Architecture</h6>
												<p className="fs-7 text-300 fw-regular">Designing robust <span className="text-secondary-2">Monolithic or Microservices architectures</span> tailored to your project scale. I optimize web performance using <span className="text-secondary-2">Golang + gRPC</span> for high-efficiency services and <span className="text-secondary-2">Laravel</span> for stable, maintainable backend solutions.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Custom Digital Ecosystems</h6>
												<p className="fs-7 text-300 fw-regular">Crafting  <span className="text-secondary-2">diverse digital solutions tailored to specific business needs.</span>  I specialize in building secure, high-traffic web applications with complex management features and seamless integrations, regardless of the industry.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular">Boost your <span className="text-secondary-2">applications with AI</span> for improved efficiency, automation, and enhanced user experience</p>
											</div>
										</div>
									</div>
