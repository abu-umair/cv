									...
									<div className="row g-4">
										...
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular">Enhancing web performance using <span className="text-secondary-2">Golang + gRPC</span> for high-efficiency backend services and <span className="text-secondary-2">Laravel</span> for robust web solutions. Specializing in low-latency communication and scalable architecture to deliver superior speed.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular">Developing high-traffic <span className="text-secondary-2">E-commerce</span> and <span className="text-secondary-2">EdTech</span> platforms. I specialize in building secure web applications with seamless payment integrations and complex management features tailored to any industry.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
