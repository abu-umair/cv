...
const projects = [
	{
		...
		technologies: "Go, gRPC, React.js, TypeScript, PostgreSQL,Supabase",
		image: "assets/imgs/home-page-2/projects/furniture.jpg",
		liveLink: "#",
		githubLink: "#"
	},
	{
		...
		// duration: "4 months",
		technologies: "React.js, Tailwind CSS, Laravel, MySQL, FrankenPHP, Caddy, VPS Deployment, Mobile APIs",
		image: "assets/imgs/home-page-2/projects/hisfarma.jpg",
		liveLink: "#",
		githubLink: "#"
	},
	{
		...
		// duration: "4 months",
		technologies: "React.js, Websocket, Laravel, PayPal Integration, MySQL, Mobile APIs",
		image: "assets/imgs/home-page-2/projects/hellohome.jpg",
		liveLink: "#",
		githubLink: "#"
	},
	{
		...
		// duration: "4 months",
		technologies: "Laravel, React.js, Gopay.cz Payment Gateway, MySQL, Mobile APIs",
		image: "assets/imgs/home-page-2/projects/cermatik.jpg",
		liveLink: "#",
		githubLink: "#"
	},
];
						...
						<div className="box-linear-animation position-relative z-1">
							<div className="p-lg-8 p-md-6 p-3 position-relative z-1">
								...
								<div className="position-relative">
														...
														<div className="row">
															...
															<div className="col-lg-7 ps-lg-5 mt-5 mt-lg-0">
																...
																<ul className="mt-4 list-unstyled">
																	...
																	<li className="text-dark mb-3 border-bottom pb-3">
																		<div className="d-flex">
																			<p className="mb-0 me-lg-8">Client</p>
																			<p className="text-300 mb-0">{project.client}</p>
																		</div>
																	</li>
																	...
																	{/* <li className="text-dark mb-3 border-bottom pb-3">
																		<div className="d-flex justify-content-between">
																			...
																			<p className="text-300 mb-0">{project.duration}</p>
																		</div>
																	</li> */}

																	<li className="text-dark mb-3 border-bottom pb-3">
																		<div className="d-flex">
																			<p className="mb-0 me-lg-2">Technologies</p>
																...
																{/* <div className="d-flex flex-wrap align-items-center gap-3 mt-7">
																	<Link href={project.liveLink} className="text-300 border-bottom border-1 px-2 pb-2 link-hover">
																	...
																	<Link href={project.githubLink} className="text-300 border-bottom border-1 px-2 pb-2 link-hover">
									...
									<div className="position-absolute bottom-0 end-0 gap-2 pb-0 pe-5 d-none d-md-flex">
