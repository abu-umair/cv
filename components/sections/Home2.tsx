							...
							<div className="row align-items-end py-60">
								<div className="col-lg-5 ps-lg-5 text-lg-start text-center">
									<div className="position-relative mb-lg-0 mb-5">
										<img src="assets/imgs/home-page-2/hero-1/my-pic.webp" alt="zelio" />
								...
								<div className="col-lg-6 mx-lg-auto col-md-12">
									<div className="p-lg-0 p-md-8 p-3">
										<div className="text-secondary-2 d-flex align-items-center">
											...
											<div className="text-dark">
												<div className="typewriter">
													<h1 className="fs-6 fw-medium">Hey, I’m Ridwan</h1>
												</div>
											</div>
											&lt;/span&gt;
										</div>
										...
										<p className="mb-6 text-secondary-2">&lt;p&gt;<span className="text-dark">With expertise in cutting-edge technologies such as</span> <span className="text-secondary-2">Golang</span>, <span className="text-secondary-2">Laravel</span>, <span className="text-secondary-2">React</span>, and <span className="text-secondary-2">Next.js</span><span className="text-dark">. From high-performance <span className="text-secondary-2">gRPC</span> services to responsive UI with <span className="text-secondary-2">Tailwind CSS</span>. I deliver innovative solutions tailored to modern business needs.</span>&lt;/p&gt;</p>
										<div className="row">
											<div className="col-7">
												{/* Carausel Scroll */}
