				...
				<div className="offCanvas__side-info mb-30">
					<div className="contact-list mb-30">
						...
						<div className="mb-3">
							...
							<p className="mb-0">+62-89654-999-868</p>
						</div>
						<div className="mb-3">
							<span className="text-400 fs-5">Email</span>
							<p className="mb-0">wawanleite@gmail.com</p>
						</div>
						<div className="mb-3">
							<span className="text-400 fs-5">Linkedin</span>
							<p className="mb-0">Muhammad Ridwan</p>
						</div>
						<div className="mb-3">
							<span className="text-400 fs-5">Address</span>
							<p className="mb-0">Bogor Selatan, Indonesia</p>
						</div>
					</div>
